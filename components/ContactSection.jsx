...
import { Box, Card, CardHeader, Chip, Container, Grid, Typography, CardTitle, CardDescription, CardContent, TextField, InputLabel, TextareaAutosize, Button } from '@mui/material'
    ...
    const contactInfo = [
        {
            ...
            title: "Our Location",
            details: "123 Business Avenue, Tech City, CA 94103",
        },
        {
            icon: <Mail className="h-5 w-5" />,
            title: "Email Us",
            details: "info@devco.com",
        },
        {
                        ...
                        <Grid item size={{ xs: 12, md: 6 }}>
                            ...
                            >
                                ...
                                <Box className="space-y-4">
                                    {
                                        contactInfo?.map((info, index) => (
                                            <Box key={index} sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                                                <Box className="p-2 rounded-md bg-slate-100 text-[#B91C1C]">
                                                    {info.icon}
                                                </Box>
                                ...
                                <Box className="aspect-video rounded-lg overflow-hidden shadow-md mt-6">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.1289207044937!2d-122.39999708439204!3d37.78992207975652!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085807ded297e89%3A0xcfd1fa1116c9947!2sFinancial%20District%2C%20San%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                                        width="100%"
                                        height="100%"
                                        style={{ border: 0 }}
                                        allowFullScreen
